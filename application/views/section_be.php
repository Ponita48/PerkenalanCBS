					...
					<center>
						<table>
							<tbody>
								<?php for ($i=1; $i <= 14; $i++) {  ?>
									<tr>
										<td id="kotak_be_<?php echo "$i";?>" style="height: 155px; min-width: 115px"><img src="<?php echo base_url(); ?>img/img1.jpg" class="img-thumbnail" id="foto_be_<?php echo "$i";?>" style="width: 90px; height: 120px"></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
