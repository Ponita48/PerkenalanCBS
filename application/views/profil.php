			...
			<div class="person-box">
				...
				<?php if (isset($this->session->userdata['logged_in'])): ?>
					...
					<?php if ($this->session->userdata['logged_in']['role'] != "admin"): ?>
						...
						<?php else : ?>
							<a href="<?php echo base_url(); ?>request/<?php echo $result->id_user; ?>"><button class="btn btn-warning" type="submit">Send Request</button></a><br><br>
						<?php endif ?>
					<?php endif ?>
					<!-- admin ngeliat -->
					<?php if ($this->session->userdata['logged_in']['role'] == "admin"): ?>
